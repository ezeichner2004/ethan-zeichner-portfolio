...
- Click on the image in the middle showing the GUIformat interface, which will launch a download. Download the program to a directory or file of your choice.
- The image shows GUIformat being downloaded to a 128gb flash drive. Be sure that the drive you download GUIformat to is not the drive you wish to format, as the program doesn’t allow you to do so.
<img src="./image/2.png" />
